...
class Sub extends Super{
	int z;
	Sub(){ super();System.out.println("Sub()생성자 호출!");}
	Sub(int x){  super(x); System.out.println("Sub(x)생성자 호출!");}
	Sub(int x,int y){ super(x,y); System.out.println("Sub(x,y)생성자 호출!");}
	Sub(int x,int y, int z){super(x,y); System.out.println("Sub(x,y,z)생성자 호출!");this.z=z;}
	void ShowXYZ() {
